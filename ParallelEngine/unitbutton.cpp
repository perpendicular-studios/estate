...
UnitButton::UnitButton(float x1, float y1, float x2, float y2, ALLEGRO_BITMAP* bitmap, bool visible, Entity* target_, Player* player_) : Button(x1, y1, x2, y2, bitmap, visible, DEFAULTSTATE), 
